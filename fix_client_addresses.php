<?php
// This script fixes the client_addresses table issue
// Set the correct path to the database connection file
$root_path = __DIR__;
require_once $root_path . "/templates/includes/db.php";
